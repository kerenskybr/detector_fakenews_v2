...
print('Acuracia do modelo Regressão Logística: {:.2f}'.format(classificador.score(x_test_tfidf, y_test)))
...
print('Acuracia AdaBoost: {:.2f}'.format(clf_ada.score(x_test_tfidf, y_test)))
...
print('Acuracia do modelo Naive Bayes: {:.2f}',np.mean(preditor_nb == y_test))
